...
final class NonEmptyDataStringTest extends AbstractWithTester
{
    ...
    public function dataNonEmptyStringThrowsExceptionWhenNullWithoutDefaultValue(): void
    {
        ...
        $this->getDataExtractionContainer()->getLooseArrayNonEmptyDataExtractionService()->getNonEmptyString(
            self::JSONAPI_DATA,
    ...
    {
        $result = $this->getDataExtractionContainer()->getLooseArrayNonEmptyDataExtractionService()->getNonEmptyString(
            self::JSONAPI_DATA,
