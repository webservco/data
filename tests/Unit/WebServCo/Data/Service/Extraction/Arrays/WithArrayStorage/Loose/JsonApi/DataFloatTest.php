...
final class DataFloatTest extends AbstractWithTester
{
    ...
    public function dataFloatThrowsExceptionWhenNullWithoutDefaultValue(): void
    {
        ...
        $this->getDataExtractionContainer()->getLooseArrayDataExtractionService()->getFloat(
            self::JSONAPI_DATA,
    ...
    {
        $result = $this->getDataExtractionContainer()->getLooseArrayDataExtractionService()->getFloat(
            self::JSONAPI_DATA,
