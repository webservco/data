...
final class NonEmptyDataFloatTest extends AbstractWithTester
{
    ...
    public function dataNonEmptyFloatThrowsExceptionWhenNullWithoutDefaultValue(): void
    {
        ...
        $this->getDataExtractionContainer()->getStrictArrayNonEmptyDataExtractionService()->getNonEmptyFloat(
            self::JSONAPI_DATA,
    ...
    {
        $result = $this->getDataExtractionContainer()->getStrictArrayNonEmptyDataExtractionService()->getNonEmptyFloat(
            self::JSONAPI_DATA,
